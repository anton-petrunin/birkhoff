...
There is a number of statements in the geometry of neutral planes which are equivalent to the Axiom~\ref{def:birkhoff-axioms:4}.
...
An neutral plane is Euclidean if and only if one of the following equivalent conditions holds.
\begin{enumerate}[(a)]

...
One cannot use the Theorem~\ref{thm:inscribed-quadrilateral} to solve of the exercise above since
it use Theorems~\ref{thm:tangent-angle} and \ref{thm:inscribed-angle},
which in turns use Theorem~\ref{thm:3sum}.
...
Prove the \index{SAA congruence condition}\emph{side-angle-angle congruence condition} in absolute plane.
...
Arguably, the discovery of hyperbolic geometry was the second main scientific discoveries of 19th century, 

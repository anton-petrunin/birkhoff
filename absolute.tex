...
There are many statements in neutral geometry that are \textit{equivalent} to the Axiom~\ref{def:birkhoff-axioms:4}.
...
we label it h-$\!$\ref{def:birkhoff-axioms:4} as a {}\emph{hyperbolic version} of Axiom~\ref{def:birkhoff-axioms:4}.

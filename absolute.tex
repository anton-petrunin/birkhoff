...
Prove the \index{SAA congruence condition}\emph{side-angle-angle congruence condition} holds in the absolute geometry.
...
where $k\le 0$, is the so called \index{curvature}\emph{curvature} of the absolute plane, which we are about to introduce.

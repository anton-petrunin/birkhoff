...
By \ref{thm:signs-of-triug}, the angles $CAB$, $ABC$ have the same sign and
since $X$ and $B$ lie on the same side of $(AC)$, we also have that the angles $CAB$ and $ABX$ have the same sign.

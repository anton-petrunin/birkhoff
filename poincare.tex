...
Taking the exponential function of the left and the right hand side and applying obvious algebra manipulations, we get
$$x=\frac{e^y-1}{e^y+1}.$$
\qedsf
...
The following exercise will be used in the proof of the hyperbolic Pythagorean theorem (\ref{thm:pyth-h-poincare}).

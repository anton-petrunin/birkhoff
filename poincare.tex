...
Namely, we construct  so called \index{conformal disk model}\emph{conformal disk model} of hyperbolic plane.
This model was discovered by Beltrami in  \cite{beltrami} 
and often called \index{Poincar\'e disc mode}\emph{Poincar\'e disc model}. 
...
The set of points inside the absolute will be called \index{hyperbolic plane}\index{plane!hyperbolic plane}\emph{hyperbolic plane} (or \index{plane!h-plane}\index{h-plane}\emph{h-plane}).

...
Similarly a triangle in h-plane; that is, an ordered triple of h-points, say $(P,Q,R)$, will be called \emph{h-triange $PQR$} and denoted by \index{21@$\triangle_h$}$\triangle_h P Q R$.
...
such that $P\ne Q$ and $R\ne Q$.
The \emph{hyperbolic angle $PQR$} (briefly $\angle_h PQR$)\index{11@$\angle_h$} is ordered pair of h-half-lines $[QP)_h$ and $[QR)_h$.

...
at~$Q$.
Then the \index{angle measure!hyperbolic angle measure}\index{hyperbolic angle measure}\emph{hyperbolic angle measure} (or \index{h-angle measure}\emph{h-angle measure}) of $\angle_h PQR$ denoted by

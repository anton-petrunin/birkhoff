...
to construct the model of hyperbolic plane --- a neutral plane that is not Euclidean.
...
let $\Gamma$ denotes the circle perpendicular to the absolute and centered at~$Z$.
According to Lemma~\ref{lem:P-->O},

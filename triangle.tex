...
The point of intersection of the perpendicular bisectors is called circumcenter.
...
are also perpendicular bisectors of the triangle $A' B' C'$.
...
Similarity of triangles provides a method for solving geometrical problems.
To applying this method, we have to search for pairs of similar triangles and then use the proportionality of corresponding sides and/or equalities of corresponding angles.

Starting from Pythagorean theorem we used this method several times.
...
Also note that $B$ and $C$ lie on the opposite sides of~$(AD)$.
Therefore, by the transversal property (\ref{thm:parallel-2}),

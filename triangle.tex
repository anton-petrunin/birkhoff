...
The three altitudes of any nondegenerate triangle intersect at a single point.
\end{thm}
...
The three medians of any nondegenerate triangle intersect at a single point.
...
Recall that distance from a line $\ell$ to a point $P$ is defined as the distance from $P$ to its footpoint on $\ell$; see Section~\ref{sec:perp<oblique}. 
...
By the definition, the vertices of an \index{triangle!orthic triangle}\index{orthic triangle}\emph{orthic triangle} are the base points of the altitudes of the given triangle.

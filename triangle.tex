...
\begin{lpic}[t(-8mm),b(0mm),r(0mm),l(1mm)]{pics/angle-bisect-lemma(1)}
\lbl[bl]{23,11;$A$}
\lbl[br]{1,18;$B$}
\lbl[rb]{21,36;$C$}
%\lbl[t]{13.5,26;$Z$}
...
If $\measuredangle XBY= \measuredangle BXZ$
then $Z=Y$.
In this case$(AB)=(BC)$ since both lines $(AB)$ and $(BC)$ are perpendicular bisectors of $[XY]$. 
The latter contradicts the assumption.
Therefore 
\[\measuredangle XBY= -\measuredangle BXZ\eqlbl{eq:iff-chain}\]

By Proposition~\ref{prop:reflection}, $A$ lies on the bisector of $\angle XBY$
and $B$ lies on the bisector of $\angle XBZ$.
Therefore
\begin{align*}

...
<
\epsilon.\]
(The definition given above provides a formal way to say that sufficiently small changes of $A$ result in arbitrarily small changes of $f(A)$.)
...
%???(
Indeed, arguing by contradiction, assume that $\triangle ABC\cong \triangle BCA$; that is, there is a motion $f$ of $(\mathbb{R}^2,d_1)$ which sends $A\mapsto B$ and $B\mapsto C$.
%???)

...
\item\index{Manhattan metric}\emph{Manhattan metric,} denoted as $d_1$ and defined as 
$$d_1(A,B)=|x_A-x_B|+|y_A-y_B|.$$
\item\index{maximum metric}\emph{Maximum metric,} denoted as $d_\infty$ and defined as 
...
\ %???blank page to start axioms on even page.

...
Namely, given distinct points $A$, $B$, and $X$ on a line, let us define the \index{signed ratio}\emph{signed ratio} $(\frac{AX}{BX})\df\pm\frac{AX}{BX}$, where the sign is chosen to meet the equation

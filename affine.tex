...
This observation can be used to prove impossibility of some constructions;
here is one example:
...
If $x=0$ or $y=0$, then the second statement follow directly from the proposition.
...
therefore $\alpha$ is also a composition of reflections and inversions as well.
\qeds

...
i.e., we will write $\left(\begin{smallmatrix}
x\\y
...
Then $\gamma$ is the identity map; i.e. $\gamma\left(\begin{smallmatrix}
x\\ y
\end{smallmatrix} \right)
=
\left(\begin{smallmatrix}
...
\end{smallmatrix} \right);
\]
i.e., either $\alpha'''$ is the identity map 

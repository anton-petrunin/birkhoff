...
Namely, given distinct points $A$, $B$, and $X$ on one line, let us define the \index{signed ratio}\emph{signed ratio} $(\frac{AX}{BX})=\pm\frac{AX}{BX}$, where the sign is chosen to meet the equation

...
Suppose that function $f\:\mathbb{R}\to\mathbb{R}$ satisfies the condition (\ref{lem:R-auto:c}) in the lemma.
Show that $f(1)=0$ or $f(1)=1$.
\end{thm}
...
\emph{any inversive transformation is a composition of inversions} ---

...
We will get an equation of the image of the line.
The equation has the same type as \ref{ax+by+c=0}, with different constants $p$, $q$, and $r$; 
in particular, it describes a line.

That is, $\beta$ is a bijection of the plane that maps lines to lines.
\qeds
...
\addtocontents{toc}{The fundamental theorem of affine geometry.}

The fundamental theorem of affine geometry is a converse to Theorem~\ref{thm:affine=linear}.
%proved by Christian von Staudt \cite{staudt}.
...
\parit{Proof of \ref{thm:affine=linear2}.}

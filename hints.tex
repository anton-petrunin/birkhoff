...
If $\triangle ABC$ is obtuse, then orthocenter coincides with one of the \index{excenter}\emph{excenters} of $\triangle ABC$;
that is, 
...
\parbf{Exercise~\ref{ex:two-chords}.} Apply the transversal property (\ref{thm:parallel-2}) and the theorem on inscribed angle (\ref{thm:inscribed-angle}).
...
Apply Hyperbolic Pythagorean theorem and the definition of hyperbolic cosine.

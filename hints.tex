...
To prove the converse, fix an inversive transformation~$\alpha$.
If $\alpha(\infty)=\infty$, then $\alpha$ maps circles to circles.
By \ref{ex:circle=affine}, $\alpha$ is an affine transformation.
Use it to show that $\alpha$ is a composition of motions and rescalings (defined in Exercise~\ref{ex:afine-linear}\textit{\ref{ex:afine-linear:scaling}})

If $\alpha(\infty)\ne \infty$, then let $P=\alpha(\infty)$.
Consider an inversion $\beta$ such that $\beta(P)=\infty$.
Let $\gamma=\beta\circ\alpha$; note that $\gamma(\infty)=\infty$.
Since $\alpha$ and $\beta$ meet the condition, so is $\gamma$.
...
\parbf{\ref{ex:ceva-affine}.} Apply Menelaus's theorem twice for $\triange BCC'$ and line $(AA')$ 
and for $\triange ACC'$ and line $(BB')$.

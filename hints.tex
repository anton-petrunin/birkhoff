...
Use the transversal property (\ref{thm:parallel-2}) to show that $(AB)\parallel (CD)$. Repeat the argument to show that $(AD)\parallel(BC)$ 
...
\begin{lpic}[t(-2mm),b(-6mm),r(0mm),l(0mm)]{pics/absolute-triangle-4(1)}
\end{lpic}
\end{wrapfigure}
...
\begin{lpic}[t(-10mm),b(-1mm),r(0mm),l(-0mm)]{pics/h-circle-5(1)}
\lbl[tr]{22,20;$Q$}
\lbl[t]{37,20;$P$}
\lbl[br]{21,37;$R$}
\lbl[tr]{1,21;$A$}
...
with right angle at $Q$, such that $PQ_h\z=QR_h$
...
For part \textit{(\ref{ex:dual-desargues-construction:b})}, apply one of the discussed theorems to construct a line parallel to the given one and then apply part \emph{(\ref{ex:dual-desargues-construction:a})}.
...
\begin{lpic}[t(-4mm),b(-3mm),r(-2mm),l(0mm)]{pics/tessellation(1)}
\lbl[br]{8,27;$A$}
\lbl[bl]{22,27;$B$}
\lbl[t]{15,23;$C$}
\end{lpic}
...
Let $O$ denotes the center of the unit sphere~$\Sigma$.
...
\parbf{Exercise~\ref{ex:hex}.} Consider the bijection $P\leftrightarrow \hat P$ of the h-plane with absolute~$\Omega$.
...
Finally, note that \ref{coshb}, \ref{cosh(c)} and \ref{cosh(a)} imply the theorem.
...
To show uniqueness, assume there is another fractional linear transformation
...
\begin{wrapfigure}{r}{35mm}
\begin{lpic}[t(-4mm),b(0mm),r(0mm),l(0mm)]{pics/polar-polar(1)}
\lbl[b]{32,21;$P$}
\lbl[l]{23,8;$X'$}
\lbl[l]{23,31.5;$X$}
\lbl[bl]{7,3.5;$Y$}
...
Let $h_A$ and $h_C$ denote the distances from $A$ and $C$ to the line~$(BD)$.
...
Set $a=AB=BC=CA$.
Let $h_1$, $h_2$ and $h_3$ denote are the distances from $X$ to the sides $[AB]$, $[BC]$ and~$[CA]$. 

...
\chapter[Hints]{\vspace*{-20mm}Hints\vspace*{-10mm}}
...
Note that in this case one of the three triangle inequalities involving the points $A$, $B$, and $C$ becomes an equality.
...
For $d_\infty$ show that $(x,|x|)\mapsto x$ is an isometry from the graph to~$\mathbb{R}$.
...
Show and use that $\gamma'\equiv\gamma$ $\Rightarrow$ $\gamma'=\gamma$.

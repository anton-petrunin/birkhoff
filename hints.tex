...
\parbf{Exercise~\ref{ex:tangent}.} Use \ref{prop:arc(angle=tan)} and \ref{thm:3sum} to show that 
...
\begin{wrapfigure}[7]{r}{44mm}
\begin{lpic}[t(-10mm),b(-6mm),r(0mm),l(0mm)]{pics/absolute-triangle-4(1)}
\end{lpic}
\end{wrapfigure}

...
Therefore by Corollary~\ref{cor:invese-comp}, $f$ must commute with the inversion in the unit circle. 
The latter can be written as an identity:
\[\frac{\bar c\cdot \bar z+\bar d}{\bar a\cdot \bar z+\bar b}
=\frac{a/\bar z+b}{c/\bar z+d},\]
which leads to the required statement. 

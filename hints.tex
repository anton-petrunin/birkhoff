...
Use Axiom~\ref{def:birkhoff-axioms:2a} and Theorem~\ref{thm:straight-angle} to construct a point $C\notin (AB)$.

Fix two distinct points $X,Y\in (AB)$.
Use  Proposition~\ref{lem:line-line} to show that the lines $(CX)$ and $(CY)$ are distinct.

Conclude that the set of all lines $(CX)$ for $X\in(AB)$ is infinite.

...
\parbf{Exercise~\ref{ex:line-coord}.} Note that $MA=MB$ if and only if
...
\parbf{Exercise~\ref{ex:circle-coord}.} Rewrite it the following way and think 
...
\parbf{Exercise~\ref{ex:proj-cross-ratio}.}
...
otherwise. (See Exercise~\ref{ex:cross-ratio-area} for another proof.)
...
\parbf{Exercise~\ref{ex:pappus-converse}.} Observe that the statement is equivalent to Pappus' theorem.
...
\parbf{Exercise~\ref{ex:dual-configurations}.}
...
\parbf{Exercise~\ref{ex:comparison}.}
A ruler and compass is strictly stronger than a set-square which is strictly stronger than a ruler and a parallel tool.

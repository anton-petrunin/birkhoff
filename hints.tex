...
By SSS we get that $\measuredangle ABX=\pm\measuredangle ABX'$.
Since $X\ne X'$, we get that
...
denote by $Y$ the intersection point.
...
\begin{lpic}[t(2mm),b(0mm),r(0mm),l(0mm)]{pics/ex-obtuce(1)}
\lbl[t]{20,8;$A$}
\lbl[tr]{5.5,8;$B$}
\lbl[br]{2,21;$C$}
\lbl[tl]{8,4;$D$}
...
\parit{(b)} Apply Theorem~\ref{thm:abc}.
...
\begin{lpic}[t(-3mm),b(-0mm),r(-1mm),l(0mm)]{pics/perp=constr(1)}
\end{lpic}
\end{wrapfigure}
...
\begin{center}
\begin{lpic}[t(2mm),b(0mm),r(0mm),l(0mm)]{pics/4-circles-sol(1)}
\lbl[r]{0,16;$P$}
\lbl[t]{24,17;$Q$}
\lbl[t]{49,19;$Q'$}
\lbl[r]{17.5,20;$A$}
...
Apply an inversion with center $P$. 
...
\begin{wrapfigure}[7]{o}{48mm}
\begin{lpic}[t(-0mm),b(-1mm),r(0mm),l(0mm)]{pics/ex-inverse(1)}
\lbl[bl]{28,9;$B'$}
\lbl[br]{19,9;$A$}
\end{lpic}
\end{wrapfigure}
...
survives under an inversion in a circle perpendicular to the absolute.
By the main observation (\ref{thm:main-observ})
we can assume that the h-midpoint of $[PQ]_h$ is the center of the absolute which will be denoted by $O$.

Without loss of generality we can assume that the absolute is a unit circle.
Set $a=OP=OQ$, then 
...
\end{align*}
Therefore
\begin{align*}\frac{PQ\cdot  P'Q'+PQ'\cdot  P'Q}{PP'\cdot QQ'}
...
\begin{lpic}[t(6mm),b(0mm),r(0mm),l(0mm)]{pics/absolute-triangle-4(1)}
\end{lpic}
\end{wrapfigure}
...
Let $\phi$ be the angle of parallelism of $B$ to~$(AC)_h$.
Note that 
\[|\measuredangle_hABC|<2\cdot \phi.\]
By triangle inequality, the h-distance from $B$ to $(AC)_h$ is at least 50.
By Proposition~\ref{prop:angle-parallelism},
\[50\le \tfrac12\cdot\ln\tfrac{1+\cos\phi}{1-\cos\phi}.\]
Rough estimates, like $\cos\phi\z\le 1-\tfrac1{10}\cdot\phi^2$ for $|\phi|<\tfrac\pi2$ and $e^3>10$ should help to finish the proof.
...
\begin{lpic}[t(-8mm),b(-1mm),r(0mm),l(-0mm)]{pics/h-circle-5(1)}
\lbl[tr]{22,20;$Q$}
\lbl[t]{37,20;$P$}
\lbl[br]{21,37;$R$}
\lbl[tr]{1,21;$A$}
...
To extend this bijection to whole projective plane assume that 
(1) the ideal line  corresponds to the origin 
and (2) the ideal point given by the pencil of the lines $a\cdot x-b\cdot y=c$ for different values of $c$ corresponds to the line given by the equation $a\cdot x+b\cdot y=0$.
...
\parit{(\ref{ex:s-medians:b}).} Mote that medians of spherical triangle $ABC$ 
...
\begin{lpic}[t(-0mm),b(-3mm),r(0mm),l(-0mm)]{pics/h-medians(1)}
\end{lpic}
\end{wrapfigure}
...
Finally, note that \ref{cosh(b)}, \ref{cosh(c)} and \ref{cosh(a)} imply the hyperbolic Pythagorean theorem.
...
\\
&\equiv\tfrac\pi2.
\intertext{Note that $0<\alpha,\beta,\gamma<\tfrac\pi2$.
Hence $0<\alpha+\beta+\gamma<\tfrac32\cdot \pi$.
It follows that}
...
\begin{wrapfigure}{r}{30mm}
\begin{lpic}[t(4mm),b(-2mm),r(0mm),l(0mm)]{pics/appol(1)}
\lbl[br]{6,5;$O$}
\lbl[tl]{25,21;$P$}
\lbl[b]{21,15;$X$}
\end{lpic}
...
\begin{wrapfigure}{o}{25mm}
\begin{lpic}[t(-2mm),b(-6mm),r(0mm),l(0mm)]{pics/equleteral-verify(1)}
\end{lpic}
\end{wrapfigure}

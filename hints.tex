...
Applying rotation, reflection and rescaling, we can assume that the points $A, B$ and $W$ have the complex coordinates $0$, $1$ and $i$ correspondingly.
In this case
\begin{align*}
\measuredangle DAZ+\measuredangle DBZ+\measuredangle DCZ
&\eqiv\arg(3+i)+\arg(2+i)+\arg(1+i)=
\\
&\eqiv\arg[(3+i)\cdot(2+i)\cdot(1+i)]=
\\
&\eqiv\arg [10\cdot i]=
\\
&\eqiv\tfrac\pi2.
\end{align*}
Note that the angles are acute, therefore the sum lies from $0$ to $\tfrac32\cdot \pi$.
It follows that it has to be $\tfrac\pi2$.

...
Applying AA similarity condition, the transformation multiplies the sides of any nondegenerate triangle by some number which may depend on the triangle. 
...
the transversal property (\ref{thm:parallel-2}) to the diagonals and a pair of opposite sides and then ASA-congruence condition (\ref{thm:ASA}).
...
If the triangle $\triangle ABC$ is obtuse, then orthocenter coincides with one of the \index{excenter}\emph{excenters} of $\triangle ABC$;
that is, 
...
\begin{lpic}[t(-5mm),b(-1mm),r(0mm),l(0mm)]{pics/ex-inverse(1)}
\lbl[bl]{28,9;$B'$}
\lbl[br]{19,9;$A$}
\end{lpic}
\end{wrapfigure}
...
\begin{lpic}[t(-2mm),b(2mm),r(0mm),l(0mm)]{pics/SAA(1)}
\lbl[t]{1,.5;$B'$}
\lbl[b]{10.5,29;$A'$}
\lbl[t]{16,.5;$C'$}
\lbl[lt]{21,.5;$C''$}
...
\begin{lpic}[t(-4mm),b(0mm),r(0mm),l(0mm)]{pics/area-median-sol(1)}
\lbl[r]{8.5,23.5;$X$}
\lbl[tr]{2,36;$A$}
\lbl[tl]{36,6.5;$B$}
\lbl[tr]{1,6.5;$C$}

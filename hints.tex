...
By the AA similarity condition, the transformation multiplies the sides of any nondegenerate triangle by a number that may depend on the triangle. 
...
We can choose the coordinates so that $B=(0,0)$ and $A=(a,0)$ for $a>0$.
...
The if part follows since inverse of an affine transformation is affine.

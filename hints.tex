...
\parbf{Exercise~\ref{ex:4-sim}.} Use \ref{thm:signs-of-triug} and \ref{cor:half-plane} to show that $\angle UAB$, $\angle BVA$, and $\angle ABW$ have the same sign.
...
To prove \textit{(b)}, one needs rewirite \ref{eq:4fractions} using angles and distances between the points and apply SAS.

...
Note that $AX<AC$ and by \ref{lem:perp<oblique}, $AB\le AX$.
...
Note that $(AC)\perp (BH)$ and $(BC)\perp (AH)$ and apply \ref{thm:orthocenter}.
...
We can choose a coordinate system so that the given vertices are $(0,0)$ and $(1,0)$.
Show that the remaining vertex is $(\tfrac12,\pm\tfrac{\sqrt{3}}2)$;
observe that this point is irrational, and apply \ref{thm:set-square-constructible-numbers}.

...
If $P$, $Q$ and $\ell$ as above then $PQ$ is called \index{distance!from a point to a line}\emph{distance from $P$ to $\ell$}. 
...
Make a ruler-and-compass construction of the lines tangent to the given circle which pass through the given point.
\end{thm}

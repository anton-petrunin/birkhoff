...
\addtocontents{toc}{Reflection across  a line.}
...
\end{thm} %???change to a proposition

The motions of the plane can be divided into two types, 
\index{direct motion}\emph{direct} 
and 
\index{indirect motion}\emph{indirect}.\label{direct motion}
...
we say that \index{tangent!circles}\emph{$\Gamma$ is tangent to $\Gamma$ at $P$}; we also assume that circle is tangent to it self at any of its points.
...
Assume~$P\ne Q$.
Suppose that $P'$ denotes the reflection of $P$ across~$(OQ)$.

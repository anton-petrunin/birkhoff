...
A \index{compass-and-ruler construction}\emph{compass-and-ruler construction} in the plane is a construction of points, lines, and circles using only an idealized ruler and compass.
...
Make a compass-and-ruler construction of a line thru a given point that is perpendicular to a given line.
\end{thm}

\begin{thm}{Exercise}\label{ex:center}
Make a compass-and-ruler construction of a center 
of a given circle.
\end{thm}

\begin{thm}{Exercise}\label{ex:tangent}
Make a compass-and-ruler construction of lines tangent to a given circle that pass thru a given point.
\end{thm}

\begin{thm}{Exercise}\label{ex:tangent-circle}
Given two circles $\Gamma_1$ and $\Gamma_2$ and a segment $[AB]$
make a compass-and-ruler construction of a circle with the radius $AB$ 

...
The line $\ell$, that is passing thru $M$ and is perpendicular to $(AB)$,
...
$$|r-r'|\le OO'\le r+r'.\ \ \ \ \ \ \ \ \ \ \ \ \ $$%???space for the next pic???
...
\begin{lpic}[t(-20mm),b(0mm),r(0mm),l(1mm)]{pics/3-circ-2-point(1)}
\end{lpic}
\end{wrapfigure}

...
\centering
\begin{lpic}[t(-2mm),b(2mm),r(0mm),l(0mm)]{pics/ABPQR(1)}
\lbl[rb]{11,22;$A$}
\lbl[b]{27,22.5;$B$}
\lbl[b]{16,33.5;$P$}
\lbl[t]{16,8;$P'$}
...
To show that reflection is distance-preserving,
...
and 
\index{indirect motion}\emph{indirect motions}.\label{direct motion}
...
We say that a point $P$ lies \index{inside!inside a circle}\emph{inside} of the circle if $OP<r$; 

...
\begin{lpic}[t(-0mm),b(-0mm),r(0mm),l(0mm)]{pics/s-right-trig-new(1)}
\lbl[t]{15,13;$O$}
\lbl[rbw]{14,28;$C$}
\lbl[rb]{9,20;$B$}
\lbl[t]{20,21;$A$}
...
The map $P\mapsto P'$ is called \index{stereographic projection}\emph{stereographic projection from $\Sigma$ to $\Pi$ from the South Pole}.
...
The described map $\Sigma^+\to \Pi^+$ is called \index{central projection}\emph{central projection} of hemisphere $\Sigma^+$.

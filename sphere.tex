...
Here is an analog of the Pythagorean theorems (\ref{thm:pyth} and \ref{thm:pyth-h}) in spherical geometry.
...
Applying, \ref{eq:scal-def} and \ref{eq:scalar-s-dist}, we get
\begin{align*}
...
The described map $\Sigma^+\to \Pi^+$ is called the \index{central projection}\emph{central projection} of 

...
Segments $[AB]$, $[BC]$, and $[CA]$ are called the \index{side!of the triangle}\emph{sides of the triangle}.
...
\[|R-r|\le d\le R+r,\]
where $R$ and $r$ denote their radiuses, and $d$ is the distance between their centers.
\end{thm}

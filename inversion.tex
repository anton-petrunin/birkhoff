...
$O \in \Gamma$ $\Leftrightarrow$ $\infty \in \Gamma'$, which is equivalent to
$\infty \in \Gamma$ $\Leftrightarrow$ $O \in \Gamma'$.

The condition $\infty \in \Gamma$ means that $\Gamma$ is a line;
equivalently, for any $\epsilon > 0$, the circline $\Gamma$ contains a point $P$ such that $OP > r/\epsilon$.

...
\parit{Proof.}
Let $r$ be the radius of the circle of inversion.
...
Let $P'$ be the inverse of $P$ across a circle $\Gamma$.
Assume that $P\ne P'$.
...
the locus of points $X$ such that $\frac{PX}{P'X}=k$ is a circle which is called the \index{Apollonian circle}\emph{Apollonian circle} (see also Section \ref{sec:Apollonian circle}).
...
Assume that a circle $\Gamma'$ is the inverse of a circle $\Gamma$ centered at $Q$.
Let $Q'$ be the inverse of~$Q$.
...
\parit{Proof.} 
Let $\Gamma'$ be the inverse of~$\Gamma$.

\parit{``Only if'' part.}
Let $O$ be the center of $\Omega$
and $Q$ be the center of~$\Gamma$.
Let $X$ and $Y$ denote the points of intersection of $\Gamma$ and~$\Omega$.
...
Let $Z'$ be the inverse of $Z$ across~$\Omega$.
...
and the \index{inversor}\emph{inversor} --- a tool that constructs the inverse of a given point across the given circline.
...
and let arcs $A'B_1'C_1'$, $A'B_2'C_2'$ be their inverses.
...
Let $P$ be the inverse of a point $Q$ across a circle $\Gamma$.

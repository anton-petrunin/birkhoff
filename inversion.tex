...
and its center $O$ is called \index{inversion!center of inversion}\emph{center of inversion}.
...
the locus of points $X$ such that $\frac{PX}{P'X}=k$ forms a circle which is called \index{circle!circle of Apollonius}\emph{circle of Apollonius}.
...
is the inversion of circle $\Gamma$.
...
\index{inversion!inversion in the line}\emph{inversion in the line}
as the reflection thru this line.
This way we can talk about \index{inversion!inversion in  circline}\emph{inversion in arbitrary circline}.

...
Let $P'$ be the footpoint of $T$ on $(OP)$.
...
Let $P'$ be the inverse of $P$ across the circle $\Gamma$.
Assume that $P\ne P'$.
...
In this case, $P'$ is inverse of $P$ across the Apollonian circle.
...
Make a ruler-and-compass construction of the inverse of a given point across a given circle.
\end{thm}
...
Consider the inversion of the inversive plane across the circle $\Omega$ with the center~$O$. 
Then 
\begin{enumerate}[(a)]
...
Consider an inversion across a circle centered at a point $O$ that lies on $\Gamma$ between $A$ and~$D$.
By 
...
if a circline that passes thru $P$ and $Q$ is perpendicular to $\Omega$, then it passes thru~$P'$, and converse holds as well.
...
Think about what to do if two of the circles intersect.
\end{thm}
...
Let $P$ be the inverse of point $Q$ across a circle $\Gamma$.

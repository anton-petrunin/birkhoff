...
and the \index{inversor}\emph{inversor} --- a tool that constructs an inverse of a given point in a given circline.
...
use only circumtool and inversor to construct a circline $\Gamma$ that passes thru $P$, 
...
use only circumtool and inversor to construct a circline $\Gamma$ that perpendicular to each circle $\Omega_1$, $\Omega_2$, and $\Omega_3$.

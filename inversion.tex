...
The angle between arcs $AB_1C_1$ and $AB_2C_2$ is defined as the angle between its tangent half-lines $[AX_1)$ and $[AX_2)$. 
Using this definition, the theorem above can be reformulated in a more conceptual way:
\emph{Under inversion, the angles between arcs are preserved up to sign.}

\begin{wrapfigure}{o}{25mm}
\begin{lpic}[t(-0mm),b(0mm),r(0mm),l(2mm)]{pics/PAP(1)}
\lbl[tr]{1.5,7;$P_1$}
\lbl[t]{7,-0.5;$A$}
\lbl[tl]{16.5,3;$P_2$}
\end{lpic}
...
\begin{lpic}[t(-6mm),b(-0mm),r(0mm),l(0mm)]{pics/inversion-of-inversion(1)}
\lbl[lb]{20.5,28.5;$P$}
\lbl[t]{17,17;$Q$}
\lbl[rb]{37.5,26;$P'$}
\lbl[t]{38,16;$Q'$}

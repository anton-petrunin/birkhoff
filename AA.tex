\begin{thm}{Construction of reflection}
Construct a reflection of a given point $X$ across a given point $O$.
\end{thm}

\parit{Construction.}
\begin{enumerate}[1.]
\item Draw the line $(XO)$.
\item Construct the circle
with center $O$
that is passing thru~$X$.
\item Mark the other point of intersection of the line and the circle by $X'$; this is the reflection of $X$ across $O$.
\end{enumerate}

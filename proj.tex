...
We obtain the so-called \index{projective!plane}\index{real!projective plane}\emph{real projective plane} (or  the \index{projective!completion}\emph{projective completion} of the original plane). 

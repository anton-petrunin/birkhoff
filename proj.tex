...
Indeed, if the line $(OP)$ is parallel to $\Pi'$ (i.e., if $(OP)\cap\Pi'=\emptyset$)
...
The bijection between points and lines is called \index{duality}\emph{duality}%
...
i.e., the bijections $P\mapsto \dot P$ and $s\mapsto \dot s$
...
i.e., projective plane with finitely many points.

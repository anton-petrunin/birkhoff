...
Historically, the notion of area inspired the development the integration and the so called \label{Lebesgue measure}\emph{Lebesgue measure}.
...
lies \index{inside!inside a triangle}\emph{inside} a nondegenerate triangle $ABC$
...
\parit{Proof of Lemma~\ref{lem:bisect-ratio} via Area method.}
...
It turns out that any neutral plane and  sphere
...
The identity \ref{eq:curv-defect} suggest a simpler way to introduce area function which works on spheres and all neutral planes except for the Euclidean plane.

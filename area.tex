...
is a polygonal set which is called \index{solid!quadrilateral, parallelogram,\\ rectangle, square}\index{quadrilateral!solid quadrilateral}\emph{solid quadrilateral} and denoted by 
...
An analog of Theorem \ref{thm:area} holds in the absolute planes and spheres.

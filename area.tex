...
We say that the point $X$ lies \index{inside!a triangle}\emph{inside} a nondegenerate triangle $ABC$ if the following three conditions hold:
...
and changing $\mathcal{U}$ will require the conversion of area units.

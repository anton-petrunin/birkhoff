...
The identity \ref{eq:curv-defect} suggest an easier way to introuduce area function which works on spheres and all absolute planes except the Euclidean plane.
So one can say that Euclidean plane is the most complicated one.   

...
\centering
\begin{lpic}[t(-0mm),b(0mm),r(0mm),l(0mm)]{pics/AOBA(1)}
\lbl[b]{6,9;$B$}
\lbl[t]{18,5.5;{\small $O$}}
\lbl[b]{31,9;$A$}
\lbl[l]{30.5,1.5;$A'$}
\lbl[b]{19,12;$\alpha$}
\lbl[t]{18,1.5;$\alpha$}
...
\section*{Point reflection}
\addtocontents{toc}{Point reflection.}
...
Note that the map $X\mapsto X'$ is uniquely defined; it is called a \index{reflection!point reflection}\index{point reflection}\emph{point reflection} across $O$.

\begin{thm}{Proposition}
Any point reflection is a motion of the plane. 
\end{thm}

\parit{Proof.}
Observe that if $X'$ is a reflection of $X$, 
then $X$ is a reflection of $X'$ as well.
In other words, the composition of a point reflection with itself is the identity map.
In particular any point reflection is a bijection.

According Exercise \ref{ex:O-mid-AB+CD}, any point reflection is a distance preserving map;
hence the result.
\qeds

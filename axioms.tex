...
\chapter{The Axioms}\label{chap:axioms}
...
i.e., $h$ is a motion such that $h(A)=B$, $h(O)=O$ and $h(B)=A'$. 
...
\index{triangle!degenerate triangle}\emph{degenerate}
...
\begin{wrapfigure}[7]{o}{28mm}
\begin{lpic}[t(-0mm),b(0mm),r(0mm),l(0mm)]{pics/vertical(1)}
\lbl[b]{0,4;$A$}
\lbl[br]{22,22;$A'$}
\lbl[t]{13.5,11.5;$O$}
\lbl[tr]{4,20;$B$}

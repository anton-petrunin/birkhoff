...
\let\thefootnote\relax\footnotetext{${}^\a$ Ignor this mark ``$\a$'' for a while; its meaning  will be explained on page \pageref{a-mark}.}
...
Show that the set of lines in the plane is infinite.
\end{thm}

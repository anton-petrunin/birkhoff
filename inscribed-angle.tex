...
\parit{``If'' part.}
Assume that \ref{eq:inscribed-angle} holds for $P\notin \Gamma$.
...
Given two circular arcs $AB_1C$ and $AB_2C$, let $[AX_1)$ and $[AX_2)$ be the half-lines tangent to the arcs $AB_1C$ and $AB_2C$ at $A$, and $[CY_1)$ and $[CY_2)$ be the half-lines tangent to the arcs $AB_1C$ and $AB_2C$ at~$C$.
Show that

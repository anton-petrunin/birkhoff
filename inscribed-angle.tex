...
Let $[XX']$ and $[YY']$ be two chords of the circle $\Gamma$ with the center $O$ and the radius $r$.
...
The quadrilateral $\square ABCD$ is inscribed 
if and only~if
...
Denote by $L$, $M$ and $N$ the footpoints of $X$ on $\ell, m$ and $n$ correspondingly.

...
A triangle $ABC$ has right angle at $C$ if and only if $C\in\Gamma$.
\end{thm}
...
we also may use the term \index{circline arc}\emph{circline arc} if we want to emphasise that the arc might be degenerate.

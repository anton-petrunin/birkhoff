...
\begin{thm}{Problem}
Assume that chords $[AA']$ and $[BB']$ intersect at the point $P$ inside their circle.
Let $X$ be a point such that both angles $\angle XAA'$ and $XBB'$ are right.
Show that $(XP)\perp(A'B')$.
\end{thm}

\begin{wrapfigure}{o}{39mm}
\begin{lpic}[t(-0mm),b(-0mm),r(0mm),l(-1mm)]{pics/add-a-circle(1)}
\lbl[t]{30,9;$A$}
\lbl[r]{4,23;$B$}
\lbl[l]{25,43;$A'$}
\lbl[bl]{38,22;$B'$}
...
\parit{Solution.}
Denote by $Y$ the point of intersection of $(A'B')$ and $(XP)$.
...
One could think of 
the circumcircles of the $\square XAPB$ and $\square XAPB$ 
in the solution above as about \emph{additional constructions}.
The method is called \emph{method of additional circle}.
...
\begin{lpic}[t(0mm),b(-3mm),r(0mm),l(0mm)]{pics/two-arcs(1)}
\lbl[l]{21,35;$A$}
\lbl[bl]{42,42;$B_1$}
\lbl[tr]{13,17;$B_2$}
\lbl[bl]{32,20;$C$}

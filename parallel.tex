...
\parit{``If''-part.}
By Theorem~\ref{thm:parallel} there is unique line $(CD)$ thru $C$ that is parallel to $(AB)$.
...
Few of these circles for fixed focuses $A,B$ and different $k$ are shown on the diagram; for $k=1$, it becomes the perpendicular bisector to $[AB]$.

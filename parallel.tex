...
A quadrilateral $\square ABCD$ in the Euclidean plane is called \index{quadrilateral!nondegenerate quadrilateral}\emph{nondegenerate} if any three points from $A,B,C,D$ do not lie on one line.

...
and
$$\measuredangle ABC\equiv\measuredangle BAD.$$
(From \ref{eq:CMB=DMA}, we can not have a minus sign in the last equality.)
...
\[\measuredangle ABC=\measuredangle BAD\eqlbl{eq:ABC=BAD2}\]
and therefore 
...
From \ref{eq:ABC=BAD2} we get that $(CB)\parallel(AD)$.

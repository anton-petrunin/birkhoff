...
Recall that $X'$ is a \index{reflection of a point}\emph{reflection of a point} $X$ across a point $O$ if $O$ is the midpoint of the line segment $[XX']$.
...
By Proposition~\ref{prop:point-reflection}, the reflection is a motion.

Any angle $\angle XOY$ is vertical to its reflection $\angle X'OY'$.
By \ref{prop:vert}, $\measuredangle XOY\z=\measuredangle X'OY'$.
Therefore, the reflection cannot be indirect.

By \ref{ex:3-reflections}, any motion is either direct or indirect.

...
By definition of the reflection across $O$, we have that $OX=OX'$, $OY=OY'$, and the angles $XOY$ and $X'OY'$ are vertical;
...
The exercises in this section are given as illustrations to the method of coordinates --- they will not be used further in the sequel.
...
A few of these circles for diﬀerent values $k$ are shown on the diagram;
for $k=1$, it becomes the perpendicular bisector to $[AB]$.

...
\begin{thm}[\abs]{Proposition}\label{prop:perp-perp}Let $\ell$, $m$ and $n$ be the lines.
...
Assume $\triangle ABC$ is a right triangle with right angle at~$C$.
Then
$$AC^2+BC^2=AB^2.$$ 

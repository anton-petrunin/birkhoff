...
This makes it possible to cover the material faster and more rigorously than in high school.
...
Inversion will be used to construct the model of the hyperbolic plane.
...
In (\ref{chap:h-plane}) we discuss the geometry of the constructed hyperbolic plane --- this is the high point in the book.
...
We encourage you to use the visual assignments on the author's website.

\textbf{Classroom exercises} usually illustrate newly introduced concepts and are intended to be discussed in class.
...
Most of the proofs in the book have already appeared in Euclid's Elements.
...
\item {}\emph{Geometry} by Igor Sharygin \cite{sharygin} --- the greatest textbook in geometry for school students.

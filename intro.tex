...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,scale=1.4,
  ...
  \node[main node] (1) at (0,15/6) {\ref{chap:metr}};
  \node[main node] (2) at (1,15/6){\ref{chap:axioms}};
  \node[main node] (3) at (2,15/6) {\ref{chap:half-planes}};
  \node[main node] (4) at (3,15/6) {\ref{chap:cong}};
...
(\ref{chap:angle-sum}) Angle sums and transversal property.

...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,scale=1.4,
  ...
  \node[main node] (1) at (-7,15/6) {\ref{chap:metr}};
  \node[main node] (2) at (-6,15/6){\ref{chap:axioms}};
  \node[main node] (3) at (-5,15/6) {\ref{chap:half-planes}};
  \node[main node] (4) at (-4,15/6) {\ref{chap:cong}};
  \node[main node] (5) at (-3,15/6) {\ref{chap:perp}};
  \node[main node] (6) at (-3.5,10/6) {\ref{chap:parallel}};
  \node[main node] (61) at (-3,5/6) {\ref{chap:angle-sum}};
  \node[main node] (7) at (-4,5/6) {\ref{chap:triangle}};
  \node[main node] (8) at (-2,5/6){\ref{chap:inscribed-angle}};
  \node[main node] (9) at (-1.5,10/6) {\ref{chap:inversion}};
  \node[main node] (10) at (-2,15/6) {\ref{chap:non-euclid}};
  \node[main node] (11) at (-1,15/6){\ref{chap:poincare}};
  \node[main node] (12) at (0,15/6) {\ref{chap:h-plane}};
  \node[main node] (13) at (-1,5/6) {\ref{chap:trans}};
  \node[main node] (14) at (-0,5/6) {\ref{chap:proj}};
  \node[main node] (15) at (-.5,10/6) {\ref{chap:sphere}};
  \node[main node] (16) at (.5,10/6) {\ref{chap:klein}};
  \node[main node] (17) at (-2.5,10/6) {\ref{chap:complex}};
  \node[main node] (18) at (-2.5,0) {\ref{chap:car}};
  \node[main node] (19) at (-3.5,0) {\ref{chap:area}};
...
\item \emph{Geometry in figures} by Arseniy Akopyan \cite{akopyan} --- an encyclopedia of Euclidean geometry almost with barely any words.

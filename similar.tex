...
\eqlbl{dist}
$$
for some $k>0$, and the corresponding angles are equal up to sign:
$$
\begin{aligned}
...
Using the new notation ``$\sim$'', Axiom~\ref{def:birkhoff-axioms:4} can be formulated the following way.
...
{Exercise}\label{ex:ptolemy} suggests an other proof of Ptolemy's inequality using complex coordinates.

...
Using the new notation ``$\sim$'', we can reformulat Axiom~\ref{def:birkhoff-axioms:4}:
...
Exercise~\ref{ex:ptolemy} below suggests an other proof of Ptolemy's inequality using complex coordinates.

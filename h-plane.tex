...
\index{equidistant}\emph{equidistant} to h-line~$m$.\footnote{It can be also ccalled \index{hypercycle}\emph{hypercycle}.}
...
Since angles of triangle have the same signs (\ref{thm:signs-of-triug}), we have
...
In particular, $OQ'_h=PQ_h$, where $Q'$ denotes the inverse of $Q$ in~$\Gamma$.

...
\parit{Proof.}
Denote by $\phi$ the angle of parallelism of $B$ to~$(AC)_h$.
...
\begin{lpic}[t(-4mm),b(0mm),r(-1mm),l(0mm)]{pics/h-inradius(1)}
\lbl[t]{1.5,4;$X$}
\lbl[t]{30.5,1;$Y$}
\lbl[b]{15,28;$Z$}
\lbl[lb]{16,13;$I$}
...
\parit{Proof.}
Let $I$ be the h-incenter of $\triangle_hXYZ$;
denote by $r$ the h-inradius of $\triangle_hXYZ$.
...
&
AA'&=\tfrac1y-y,
\intertext{Since the triangles $ABC$, $A'BC$, $AB'C$, $A'B'C$ are right, by the original Pythagorean theorem (\ref{thm:pyth}) implies}
AB&=\sqrt{x^2+y^2},
&

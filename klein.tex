...
Some problems in hyperbolic geometry are more easily proven using the projective model, while others have simpler proofs in the conformal model.
...
On the other hand, note that it is not easy to prove this statement using the conformal model.
...
However, there are two useful exceptions:
...
The projective model can be used to give another proof of the hyperbolic Pythagorean theorem (\ref{thm:pyth-h-poincare}).

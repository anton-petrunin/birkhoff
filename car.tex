...
On the other hand, it is easy to make ruler-and-compass constructions that produce segments of lengths $a+b$ and $a-b$ from two given segments of lengths $a>b$.
...
\begin{enumerate}[(a)]
 ...
 \item\label{ex:5-gon:b} Use (\ref{ex:5-gon:a}) to make a ruler-and-compass construction of a regular pentagon.
\end{enumerate}
\end{thm}

...
Use it to show that with a set-square, one cannot construct an equilateral triangle with a given base.
(You may use that $\sqrt{3}$ is an irrational number.)
\end{thm}
...
If you wonder how such theorem can be proved, read about \emph{Peaucellier--Lipkin inversor};

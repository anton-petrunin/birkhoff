...
Following the same lines as in the previous section, we can define {}\emph{ruler-and-set-square constructible numbers}
...
Let us show use this theorem to show the impossibility of some constructions with a ruler and set a square.

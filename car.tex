...
i.e., the needed compass-and-ruler construction does not exist.
...
For example:
\begin{itemize}
\item Impossibility of solution for doubling square problem states that $\sqrt[3]{2}$ is not a constructable number.
...
\section*{Construction with set square}
\addtocontents{toc}{Construction with set square.}
...
i.e., a constriction with different choice of free points.

According to Exercise~\ref{ex:inv-center not=center-inv}, 
the inversion sends the center of $\Gamma$ to an other point.
I.e., following the same construction, we can end up at a different point, a contradiction.
\qeds
...
Moreover $P\mapsto p$ is a duality.
\end{thm}

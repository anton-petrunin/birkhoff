...
\usepackage[papersize={12.713912in,9.250in}, spine=0.432384in, cropgap=0.125in
,cropmarks, cropframe
...
\put(9,8){{\hbox{\parbox{.3\textwidth}{\begin{center}
        \ttfamily\bfseries\Huge  Euclidean plane and its relatives                           
                                  \end{center}
}}}}

\put(9.05,7.4){\ttfamily\LARGE \textsc{a minimalist introduction}}

\put(9.9,7.1){\ttfamily\large Anton Petrunin}

\put(7.25,.5){\ttfamily\large \textsc{third edition}}

\put(6.34,8.8){\rotatebox{-90}{\ttfamily\bfseries\LARGE  EUCLIDEAN PLANE AND ITS RELATIVES}}

\put(6.37,1.8){\rotatebox{-90}{\ttfamily\large \textsc{anton petrunin}}}

...
\section*{On angle-side-side and angle-angle-side}
\addtocontents{toc}{On angle-side-side and angle-angle-side.}
...
An other triple is \emph{angle-angle-side}, or biefly AAS;
...
The AAS condition will not be used directly in the sequel.
One proof of this condition can be obtained from ASA and theorem on sum of angles of triangle proved below (see~\ref{thm:3sum}). 

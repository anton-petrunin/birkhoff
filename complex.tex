...
Use Theorem~\ref{thm:inversions-inversive} to conclude that any inversive transformation is either fractional linear or complex conjugate of a  fractional linear transformation.
\end{thm}

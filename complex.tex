...
If $y=0$, we say that $z$ is a \index{real complex number}\emph{real} and if $x=0$ we say that $z$ is an \index{imaginary complex number}\emph{imaginary} complex number.
The set of points 
...
The following three types of M\"obius transformations are called \index{M\"obius transformation!elementary transformation}\index{elementary transformation}\emph{elementary}.
...
is called \index{cross-ratio!complex cross-ratio}\emph{complex cross-ratio}; it will be denoted as \index{$(u,v;w,z)$}$(u,v;w,z)$.

...
The complex number $\bar z\df x-i\cdot y$ is called the \index{complex conjugate}\emph{complex conjugate} of~$z$.
...
The following theorem is a reformulation of Corollary~\ref{cor:inscribed-quadrilateral} which uses complex coordinates.
...
is indeed a reformulation of Corollary~\ref{cor:inscribed-quadrilateral}.
\end{thm}
...
\centering
\begin{lpic}[t(0mm),b(1mm),r(2mm),l(2mm)]{pics/3right-isos(1)}
\lbl[b]{12,24;$O$}
\lbl[t]{28,0;$W$}
\lbl[t]{10,0;$V$}
\lbl[r]{0,13;$P$}
...
Use it together with Theorem~\ref{thm:inscribed-quadrilateral-C} to prove that if
...
\centering
\begin{lpic}[t(-0mm),b(0mm),r(0mm),l(0mm)]{pics/6-circles(1)}
\lbl[rtw]{7,7;$U$}
\lbl[ltw]{37.5,9;$V$}
\lbl[blw]{37,30;$W$}
\lbl[rbw]{5,29;$Z$}
...
\begin{minipage}{.48\textwidth}
\centering
\begin{lpic}[t(-0mm),b(0mm),r(0mm),l(0mm)]{pics/ABUVW(1)}
\lbl[b]{2.5,38;$U$}
\lbl[r]{19.5,9.5;$V$}
\lbl[l]{42,17;$W$}
\lbl[rt]{12,2;$A$}
...
Denote by $a$, $b$, $u$, $v$, and $w$ the complex coordinates of $A$, $B$, $U$, $V$, and $W$ correspondingly.
\begin{enumerate}[(a)]
...
Finally, the reflection of $Z'$ across $\mathbb{R}$, 
